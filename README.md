...
| `create_IAM_policy` | To create the policy for for Virtual Node operations set to "true". The IAM policy is created in the root compartment in customer's home tenancy. Customer must have access to create a polciy in this compartment.| bool | yes       |
